  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <section className="relative h-screen flex flex-col justify-center items-center text-center px-6 bg-gradient-to-b from-blue-500 to-blue-700 text-white">
        ...
        >
          ProCV helps you craft the perfect resume effortlessly with AI-powered suggestions and professional designs.
        </motion.p>
        <motion.div
        ...
        >
          <Button
            ...
            size="lg"
            className="bg-white rounded-xl text-blue-600 hover:bg-blue-100 shadow-lg"
          >
        ...
        <div className="absolute flex justify-center bottom-0 w-full">
          <img
            src="./logo.svg"
            alt="ProCV Preview"
            className="object-contain max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl"
          />
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-gray-700 text-white text-center">
        ...
        <p className="text-lg mb-6">
          Join thousands of professionals using ProCV to create stunning resumes in minutes.
        </p>
        <Button
          onClick={() => navigate("/templates")}
          size="lg"
          className="bg-blue-500 rounded-xl hover:bg-blue-600 shadow-lg"
        >
